...
heroImageAlt: "Illustrated workbench scene: a blind man in headphones leans in close to an opened Morningstar ML10X loop switcher, surrounded by a braille notebook, a field recorder, a laptop showing a hand-drawn block diagram, and handwritten annotations that describe his method as listening — to relay clicks, LED ticks, MCU beeps and audio-path changes."
heroImageLongDesc: "A warmly lit, hand-illustrated workbench scene. At the centre, a man with dark curly hair, glasses and Beyerdynamic DT 770 Pro headphones leans in close to an opened Morningstar ML10X, one hand resting on the exposed circuit board, listening intently. A thought bubble at his shoulder reads 'The relay on L3 sounds slightly duller than L2... different type? different age?'. Across the top, handwritten annotations describe his method: 'I can't see the circuits, but I can hear them. Every click, every beep, every relay shift, every signal path change — a sound, a clue. I send commands. I listen. I learn. The ML10X speaks in clicks, ticks, and silence. I just have to listen carefully.' A small panel top-left, labelled 'Morningstar ML10X — MIDI controlled loop switcher', shows the device with its display reading 'Bank 03 / 01 PRISTINE'. Top-right, 'Listening to the signal flow' charts four coloured waveforms (send MIDI command, relay click, audio-path changes, new tone response) under the caption 'Different relays. Different clicks. Different paths. Different tones. That's how I map the inside.' Centre-right, a list titled 'What I'm listening for' enumerates relay clicks, LED ticks, MCU beeps, USB connect/disconnect tones, power-regulator whine, backlight PWM whine, timing differences and noise-floor changes. To its right, a laptop displays 'My map (so far)' — a hand-drawn block diagram of MIDI in, opto-isolators, an MCU, a relay driver and two loop send/return paths; a post-it beside it reads 'Step by step. Command by command. Sound by sound. The map will be complete.' In the foreground, a braille notebook labelled 'ML10X NOTES – BRAILLE' lies open, listing MIDI commands, relay responses, LED feedback, timing data, signal character, hypotheses and test results, beside a field recorder mid-capture at 00:27:14 and a mug reading 'Curiosity is my superpower'. Bottom-left, a list of 'Tools I use': ears, patience, logic, MIDI controller, audio interface, recorder, Braille notebook, curiosity. Bottom-right, a closing quote: 'Accessibility is not just about tools. It's about freedom to explore, to take things apart, and to understand them in your own way.'"
---
